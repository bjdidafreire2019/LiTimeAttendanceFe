<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="BjDiDaSoft.Core.Application.TimeAttendance.Account.OpenAuthProviders" %>
